...
<div class="row top-buffer">
    <div class="col-md-3">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li role="presentation" class="active"><a href="book-5.php">5. Additional Requirements</a></li>
    ...
    <div class="col-md-8">
        <h4>5. Additional Requirements</h4>
        <p>Please fill in the appropriate information below.</p>
        <div class="col-md-12">
            
            <br>
            <span>Your textbox:</span>
            <input type="text" class="form-control">
            <br>
            <span>Your second textbox:</span>
            <input type="text" class="form-control">
            <br>
            
            <br><br><br><br>
            <div style="text-align:right;">
                <a href="book-4.php" class="btn btn-default">Previous</a>
                <a href="book-6.php" class="btn btn-primary">Next</a>
